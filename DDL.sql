...
(
   ...
   AMOUNT_OF_OPEN_QUESTIONS         INT not null,
   AMOUNT_OF_MULTIPLE_QUESTIONS     INT not null,
   AMOUNT_OF_PROGRAMMING_QUESTION   INT not null,
   AMOUNT_TOTAL_QUESTIONS           INT not null,
   PRIMARY KEY (CAMPAIGN_ID)
);
